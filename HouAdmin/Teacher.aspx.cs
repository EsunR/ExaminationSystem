...
public partial class HouAdmin_admin000 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        dataconn.ecadabindinfostring(gvAdminInfo, "select * from tb_Teacher ORDER BY ID DESC", "ID");
    }
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            dataconn.ecadabind(gvAdminInfo, "Select * From tb_Teacher Where "
    ...
    {
        Page.Response.Redirect("teacherInsert.aspx");
    }
}
